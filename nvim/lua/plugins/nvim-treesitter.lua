return {
    ...
    branch = "master", -- moved from "main" to "master" because they removed plenty of features which require to use tree-sitter-modules but I had issue with highlighting
