return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            ...
            vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>gp", "<cmd>Lspsaga peek_definition<CR>", opts)
            vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>gt', '<cmd>Telescope lsp_type_definitions<CR>', opts)
            vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>gs",
                "<cmd>lua require('lsp_signature').toggle_float_win()<CR>", opts)
            ...
            vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cD", '<cmd>Telescope diagnostics bufnr=0<CR>', opts)
            ...
            vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>td',
                "<cmd>lua vim.diagnostic.enable(not vim.diagnostic.is_enabled()) <CR>", opts)

            -- symbols search
            vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>bs",
                "<cmd>lua require('telescope.builtin').lsp_document_symbols({symbols={'class', 'constructor', 'operator', 'interface', 'struct', 'method', 'function'}})<CR>",
                opts)
            vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ss",
                "<cmd>lua require('telescope.builtin').lsp_workspace_symbols({symbols={'class', 'constructor', 'operator', 'interface', 'struct', 'method', 'function'}})<CR>",
                opts)
