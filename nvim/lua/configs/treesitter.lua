...
M.setup = function()
    require('nvim-treesitter').install({
        "c", "cpp", "cmake", "rust", "markdown", "markdown_inline",
        "python", "bash", "lua", "json", "yaml", "javascript",
        "typescript", "html", "c_sharp", "vim", "dockerfile", "gitignore",
    })
    ...
    sel("am", "@function.outer",    "Select outer part of a method/function def")
    sel("im", "@function.inner",    "Select inner part of a method/function def")
